...
const Navbar = () => {
  ...
  return (
    <nav className="hidden md:flex justify-center w-[645px] fixed top-2  backdrop-blur-[10px] bg-primary-pri1/80 dark:bg-primary-pri1/50 z-[1000] rounded-md bg-[url(/src/assets/images/decoration/noisy.webp)]">
