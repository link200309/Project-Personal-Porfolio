...
const TechLogo = ({ logo }: TechLogoProps) => {
  ...
  return (
    <div
      className="flex items-center justify-center relative py-3 p-4 md:py-4 md:p-5 before:content-[''] before:absolute before:rounded-[50%] before:shadow-[0_0_35px_12px_var(--logo-color)] before:z-[-2] before:transition-all before:duration-300 after:content-[''] after:absolute after:border after:border-transparent after:rounded-2xl after:backdrop-blur-md after:z-[-1] after:w-full after:h-full hover:after:border-[var(--logo-color)] hover:before:shadow-[0_0_35px_18px_var(--logo-color)] hover:after:backdrop-blur-xl after:transition-all after:duration-300"
      style={
        {
